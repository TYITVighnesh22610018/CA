...
# Constants
WINDOW_SIZE = (832, 832)  # 26 * 32 = 832
TILE_SIZE = 32  # Increased from 8 to make it more visible
GRID_SIZE = 26
...
def main():
    ...
    tiles = create_puzzle("your_image.jpg")  # Replace with your image path
    ...
    # Example of optimizing rotations
